		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SapUI5 Final",
									"targetURL": "#sapui5finalsapui5final-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5finalsapui5final-display": {
								"semanticObject": "sapui5finalsapui5final",
								"action": "display",
								"description": "SapUI5 Final",
								"title": "SapUI5 Final",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5final.sapui5final",
									"url": sap.ui.require.toUrl("sapui5final/sapui5final")
								}
							}
						}
					}
